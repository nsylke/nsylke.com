...
const IndexPage = () => (
  <div className="container mx-auto mt-10 p-10">
    ...
    <div className="flex justify-center gap-2 mt-8 mb-5 text-gray-600">
      <a target="_blank" href="https://github.com/nsylke" className="hover:text-gray-800">
        GitHub
      </a>
      <span className="mx-2">&bull;</span>
      <a target="_blank" href="https://linkedin.com/in/nsylke" className="hover:text-gray-800">
        LinkedIn
      </a>
      <span className="mx-2">&bull;</span>
      <a target="_blank" href="https://x.com/nsylke" className="hover:text-gray-800">
        X (formerly Twitter)
      </a>
    </div>
  </div>
